...
class ErscheintR {
    ...
    async show() {
        ...
        let html = await fetch("Erscheint_bald_Seite/erscheint_bald_seite_Roulette.html");
        let css = await fetch("Erscheint_bald_Seite/erscheint_bald_Seite_Roulette.css");
